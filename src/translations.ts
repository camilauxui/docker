const translations = {  
    es: {  
        home: {  
            title: "Centro Médico",  
            subtitle: "Conoce todos los servicios disponibles para garantizar una atención de calidad:",  
            services: "Servicios",  
            about: "Sobre nosotros",  
            aboutText: "Nos dedicamos a cuidar de tu salud.",  
    ...
    en: {  
        home: {  
            ...
            subtitle: "Discover all the services available to ensure quality care:",  
            services: "Services",  
            about: "About us",  
            aboutText: "We are dedicated to taking care of your health.",  
